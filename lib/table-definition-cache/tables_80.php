...
$tables['uo_comment'] = array( 'type' => 'int', 'id' => 'string', 'comment' => 'blob' );
...
$tables['uo_location'] = array( 'id' => 'int', 'name' => 'string', 'fields' => 'int', 'indoor' => 'int', 'address' => 'string', 'lat' => 'real', 'lng' => 'real' );
...
$tables['uo_pool'] = array( 'pool_id' => 'int', 'name' => 'string', 'ordering' => 'string', 'visible' => 'int', 'continuingpool' => 'int', 'placementpool' => 'int', 'mvgames' => 'int', 'timeoutlen' => 'int', 'halftime' => 'int', 'winningscore' => 'int', 'timecap' => 'int', 'scorecap' => 'int', 'played' => 'int', 'addscore' => 'int', 'halftimescore' => 'int', 'timeouts' => 'int', 'timeoutsper' => 'string', 'timeoutsovertime' => 'int', 'timeoutstimecap' => 'string', 'betweenpointslen' => 'int', 'series' => 'int', 'type' => 'int', 'timeslot' => 'int', 'color' => 'string', 'forfeitscore' => 'int', 'forfeitagainst' => 'int', 'follower' => 'int', 'drawsallowed' => 'int', 'playoff_template' => 'string' );
$tables['uo_pooltemplate'] = array( 'template_id' => 'int', 'name' => 'string', 'ordering' => 'string', 'continuingpool' => 'int', 'mvgames' => 'int', 'timeoutlen' => 'int', 'halftime' => 'int', 'winningscore' => 'int', 'timecap' => 'int', 'scorecap' => 'int', 'addscore' => 'int', 'halftimescore' => 'int', 'timeouts' => 'int', 'timeoutsper' => 'string', 'timeoutsovertime' => 'int', 'timeoutstimecap' => 'string', 'betweenpointslen' => 'int', 'type' => 'int', 'timeslot' => 'int', 'forfeitscore' => 'int', 'forfeitagainst' => 'int', 'drawsallowed' => 'int' );
...
$tables['uo_season'] = array( 'season_id' => 'string', 'name' => 'string', 'starttime' => 'datetime', 'endtime' => 'datetime', 'iscurrent' => 'int', 'enrollopen' => 'int', 'enroll_deadline' => 'datetime', 'type' => 'string', 'istournament' => 'int', 'isinternational' => 'int', 'isnationalteams' => 'int', 'organizer' => 'string', 'category' => 'string', 'showspiritpoints' => 'int', 'timezone' => 'string', 'spiritmode' => 'int' );
...
$tables['uo_spirit_category'] = array( 'category_id' => 'int', 'mode' => 'int', 'group' => 'int', 'index' => 'int', 'min' => 'int', 'max' => 'int', 'factor' => 'int', 'text' => 'blob' );
$tables['uo_spirit_score'] = array( 'game_id' => 'int', 'team_id' => 'int', 'category_id' => 'int', 'value' => 'int' );
...
$tables['uo_translation'] = array( 'translation_key' => 'string', 'locale' => 'string', 'translation' => 'string' );
