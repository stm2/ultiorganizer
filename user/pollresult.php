...
if (!$hasResults && !isSeasonAdmin($season)) {
  $html .= "<h2>$title</h2>";
  ...
  $columns = array(array(_("Rank"), _("Ranked by %s"), '', null), array(_("Team"), "", '', null),
    ...
    array(_("Range"), _("Average of all scores (not counting 0s) for this team"), 'score', $avg),
    array(_("Norm"), _("Normalized sum (scores between 0 and 1)"), 'score', $norm),
    array(_("Sum"), _("Sum of all scores for this team"), 'score', $sum),
