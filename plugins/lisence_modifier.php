...
if (isset($_POST['save'])){
  $query = sprintf("UPDATE uo_license SET lastname='%s', firstname='%s', membership='%s',
			...
			external_validity='%s' WHERE accreditation_id='%s'",
				mysql_adapt_real_escape_string($_POST['lastname']),
				mysql_adapt_real_escape_string($_POST['firstname']),
				mysql_adapt_real_escape_string($_POST['membership']),
				mysql_adapt_real_escape_string($_POST['birthdate']),
				mysql_adapt_real_escape_string($_POST['accreditation_id']),
				mysql_adapt_real_escape_string($_POST['ultimate']),
				mysql_adapt_real_escape_string($_POST['women']),
				mysql_adapt_real_escape_string($_POST['junior']),
				mysql_adapt_real_escape_string($_POST['license']),
				mysql_adapt_real_escape_string($_POST['external_id']),
				mysql_adapt_real_escape_string($_POST['external_type']),
				mysql_adapt_real_escape_string($_POST['external_validity']),
				$accId);
	DBQuery($query);
