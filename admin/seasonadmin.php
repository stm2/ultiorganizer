...
$html .=  "<tr><td  style='width:40%;'><b>"._("Type")."</b></td><td>".utf8entities(U_($info['type']))."/".utf8entities($tour)."/". utf8entities($inter)."/".utf8entities($club) ."</td></tr>\n";
...
$html .=  "<tr><td><b>"._("Enrollment")."</b></td><td>".utf8entities($enrollment)." (". ShortDate($info['enroll_deadline']).")</td></tr>\n";
...
$html .=  "<tr><td><b>"._("Visible")."</b></td><td>".utf8entities($visible)."</td></tr>\n";
$html .=  "</table>";
...
$seasonIdUrl = urlencode($seasonId);
$html .=  "<tr><td style='width:80%;'><a href='?view=admin/seasonseries&amp;season=$seasonIdUrl'>".utf8entities(_("Divisions"))."</a></td>";
$html .=  "<td class='right'>".count($series)."</td>";
$html .=  "</tr>\n";

$pools = SeasonPools($info['season_id']);
$html .=  "<tr><td><a href='?view=admin/seasonpools&amp;season=$seasonIdUrl'>".utf8entities(_("Pools"))."</a></td>";
$html .=  "<td class='right'>".count($pools)."</td>";
$html .=  "</tr>\n";

$teams = SeasonTeams($info['season_id']);
$html .=  "<tr><td><a href='?view=admin/seasonteams&amp;season=$seasonIdUrl'>".utf8entities(_("Teams"))."</a></td>";
$html .=  "<td class='right'>".count($teams)."</td>";
$html .=  "</tr>\n";

$players = SeasonAllPlayers($info['season_id']);
$html .=  "<tr><td><a href='?view=admin/accreditation&amp;season=$seasonIdUrl'>".utf8entities(_("Players"))."</a></td>";
$html .=  "<td class='right'>".count($players)."</td>";
$html .=  "</tr>\n";

$reservations = SeasonReservations($info['season_id']);
$html .=  "<tr><td><a href='?view=admin/reservations&amp;season=$seasonIdUrl'>".utf8entities(_("Reservations"))."</a></td>";
$html .=  "<td class='right'>".count($reservations)."</td>";
$html .=  "</tr>\n";

$games = SeasonAllGames($info['season_id']);
$html .=  "<tr><td><a href='?view=admin/seasongames&amp;season=$seasonIdUrl'>".utf8entities(_("Games"))."</a></td>";
...
if(IsSeasonStatsCalculated($info['season_id'])){
  ...
  $html .=  "<a href='?view=admin/stats&amp;season=$seasonIdUrl'>&raquo; ".utf8entities(_("Archive statistics"))."</a><br/>";
}
$html .= "</p>\n";

$html .= "<hr/>\n";
$html .=  "<p>";
$html .= "<a href='?view=admin/eventdataexport&amp;season=$seasonIdUrl'>".utf8entities(_("Export event data"))."</a> | ";
